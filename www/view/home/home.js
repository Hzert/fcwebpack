...
module.exports = angular.module('app.home').controller('homeCtrl', function ($scope) {
    // ajaxRequest("/indexHome/getBannerList", {
    //     'password': 'jks7758258',
    //     'mobile': '18938403324',
    //     'imgCode': 'eba3',
    //     'uuidParam': '55E226D4659E737B4BBBDDEA5E9FEA23'
    // }).then((res) => {
    //
    // });
